...
import { Data as HeatmapData } from '@/features/analytics/(components)/heatmap-tables/most-common.tsx'
...
export const exportMostCommonData = async ({
	data,
	filename = 'most-common-data-export.xlsx',
	title = 'Most Common Data',
	t,
}: ExportOptions) => {
	...
	// Define headers
	const headers = [
		t('Analytics.heatmap.transition'),
		t('Analytics.heatmap.count'),
